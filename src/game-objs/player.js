...
import { projectPoint, DegToRad, randomFloatRange } from "../common/math.js"
...
export class Player extends GameObject {
   ...
   */
  fire() {
    const pos = projectPoint(this.pos, this.dir, this.size + 5)
    gameObjPool.add(new Bullet(pos.x, pos.y, this.dir))
  }

  /**
   * Desenha o jogador como um círculo verde com um traço apontando sua direção.
   * @override
   */
  draw() {
